// icons.jsx — Lucide-style line icons (recreated paths, stroke-based)
const ICON_PATHS = {
  ...
  sparkles: '<path d="M12 2.5 14.2 9.8 21.5 12 14.2 14.2 12 21.5 9.8 14.2 2.5 12 9.8 9.8z"/><path d="M19 3.5 19.7 5.8 22 6.5 19.7 7.2 19 9.5 18.3 7.2 16 6.5 18.3 5.8z"/>',
  search: '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',
  send: '<path d="M14.54 11.46 22 2l-9.46 7.46"/><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/>',
